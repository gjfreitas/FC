...
A2 = diag(1 + h./(2.*r(1:(end-1))),1);  %  uma posição relativamente a diagonal
A3 = diag(1 - h./(2.*r(2:(end))),-1);   % desce uma posição relativamente a diagonal
A3(end,end-1) = 0;
